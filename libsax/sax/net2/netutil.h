...
public:
    ...
    bool add(const int &fd,const bool &read,const bool &write,void *data = NULL, g_eda_func *proc = epoll_mgr::call_back);
    void del(const int &fd,const bool &read,const bool &write);
    void set(const int &fd,const bool &read,const bool &write);
...
public:
    ...
    inline bool add_event(const bool &read,const bool &write) {return _mgr->add(_fd, read, write, this);}
    inline void del_event(const bool &read,const bool &write) {_mgr->del(_fd, read, write);}
    void set_event(const bool &read,const bool &write) {_mgr->set(_fd, read, write);}
